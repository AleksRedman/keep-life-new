      ...
      <>
        {
          isScreenMdMin
            ...
            : <div><p>{`${langCollection[`${lang}`].itxt1_1} `}</p></div>
        }
      </>
    )
  }
    ...
    <div className={styles.donatePuzzle}>
      ...
      <div className={styles.donatePuzzleContent}>
        <div className={styles.donatePuzzleWrap}>
          <div key="dp_LTAngle" className={donatePuzzlePazzleItemLTAngleStyles}>
            {pzlItmCntnt()}
          </div>
          <div key="dp_MT" className={donatePuzzlePazzleItemMTStyles}>
            {pzlItmCntnt()}
          </div>
          <div key="dp_MT" className={donatePuzzlePazzleItemMTStyles}>
            {pzlItmCntnt()}
          ...
          <div key="dp_RTAngle" className={donatePuzzlePazzleItemRTAngleStyles}>
            {pzlItmCntnt()}
          </div>

          <div key="dp_LM" className={donatePuzzlePazzleItemLMStyles}>
            {pzlItmCntnt()}
          </div>
          <div key="dp_MM" className={donatePuzzlePazzleItemMMStyles}>
            {pzlItmCntnt()}
          </div>
          <div key="dp_MM" className={donatePuzzlePazzleItemMMStyles}>
            {pzlItmCntnt()}
          ...
          <div key="dp_RM" className={donatePuzzlePazzleItemRMStyles}>
            {pzlItmCntnt()}
          </div>
          ...
          <div key="dp_LBAngle" className={donatePuzzlePazzleItemLBAngleStyles}>
            {pzlItmCntnt()}
          </div>
          <div key="dp_MB" className={donatePuzzlePazzleItemMBStyles}>
            {pzlItmCntnt()}
          </div>
          <div key="dp_MB" className={donatePuzzlePazzleItemMBStyles}>
            {pzlItmCntnt()}
          ...
          <div key="dp_RBAngle" className={donatePuzzlePazzleItemRBAngleStyles}>
            {pzlItmCntnt()}
          </div>
        </div>
      </div>
